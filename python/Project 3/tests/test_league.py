...
from curling_league_manager import League
from curling_league_manager import Team
from curling_league_manager import Competition
from curling_league_manager import TeamMember
...
class LeagueTests(unittest.TestCase):
    ...
    def build_league():
        ...
        t1.add_member(tm1) #I think I broke PyCharm here, I was trying to fix the test on line 86, and after reverting it throws some sort of error here
        t1.add_member(tm2)
        t2.add_member(tm3)
        t2.add_member(tm4)
        t2.add_member(tm5)
